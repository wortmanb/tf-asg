...
function get_az() {
    ...
    placement=$(aws ec2 describe-instances --query 'Reservations[*].Instances[*].Placement' --filters "Name=private-dns-name,Values=${hostname}" --output text | awk '{print $1}')
    echo ${placement: -1}
}
...
# function to generate enrollment token from bootstrap host
...
# replace and uncomment cluster.name in elasticsearch.yml and set other values
